...
out={'ok':all(v is True or k=='downloads_root' for k,v in checks.items()),'stage':'downloads_integrated_create_member_no_fi_v8','checks':checks,'phase4_status':phase4.get('status'),'phase4_state':phase4.get('state')}
