...
async function getSentinelPage(profile) {
    if (!pagePromise) {
        pagePromise = (async () => {
...
async function ensureDeviceCookie(page, deviceID) {
...
async function loadSentinelFrame(page) {
...
export async function fetchSentinelTokenFromBrowser(flow, deviceID, profile) {
