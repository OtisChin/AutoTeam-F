...
from autotoken.core.env import install_legacy_env_aliases, read_env_lines, set_env_default_with_legacy_alias
from autotoken.core.paths import PROJECT_ROOT
from autotoken.core.textio import parse_env_line, parse_env_value

# 加载 .env 文件（从项目根目录）
_env_file = PROJECT_ROOT / ".env"
for line in read_env_lines(_env_file):
    parsed = parse_env_line(line)
    if parsed:
        key, value = parsed
        set_env_default_with_legacy_alias(key, value)
