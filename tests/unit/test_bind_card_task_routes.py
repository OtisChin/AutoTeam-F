...
def test_bind_card_task_run_updates_card_account_audit_and_progress(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda **kwargs: {"status": "success", "message": "ok", "screenshot_paths": ["shot.png"]},
    )
    ...
    routes["post_bind_card_task"](
        BindCardTaskParams(email="user@example.com", card_item_id="card-1", checkout_url="https://chatgpt.com/checkout/demo")
    )
