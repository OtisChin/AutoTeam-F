from autotoken.manager import MAIL_TIMEOUT, _direct_register_code_timeout
...
def test_luckmail_microsoft_register_code_timeout_uses_regular_mail_timeout():
    assert _direct_register_code_timeout(FakeMailClient("luckmail", "ms_graph"), "user@outlook.my") == MAIL_TIMEOUT
