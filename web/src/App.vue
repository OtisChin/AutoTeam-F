...
import GCashPhPage from './components/GCashPhPage.vue'
...
const PAGE_KEYS = new Set(['dashboard', 'register', 'cardpool', 'bindcard', 'gopay', 'paypal', 'ideal', 'brazilPix', 'indiaUpi', 'kakaoPay', 'momoVn', 'gcashPh', 'oauthPhones', 'oauthPhoneRecords', 'mailAccounts', 'trade', 'cpa2sub', 'oauth', 'tasks', 'logs', 'settings'])
