...
export const api = {
  ...
  getKakaoPayTempOrder: (orderId, cdk) => request('GET', `/kakao-pay/temp/orders/${encodeURIComponent(orderId)}?cdk=${encodeURIComponent(cdk)}`),
  getKakaoPayTempTicketStatus: (cdk) => request('GET', `/kakao-pay/temp/tickets/status?cdk=${encodeURIComponent(cdk)}`),
  createKakaoPayKkPaymentOrder: (payload) => request('POST', '/kakao-pay/kk-payment/orders', payload),
  ...
  resubmitKakaoPayKkPaymentOrder: (orderId, token = '', cdk = '') => request('POST', `/kakao-pay/kk-payment/orders/${encodeURIComponent(orderId)}/resubmit?token=${encodeURIComponent(token)}&cdk=${encodeURIComponent(cdk)}`),
  ...
  getICloudAccountsStatus: () => request('GET', '/config/icloud-accounts/status'),
