...
export const api = {
  ...
  exportOutlookAccounts: () => request('GET', '/config/outlook-accounts/export'),
  ...
  exportICloudAccounts: () => request('GET', '/config/icloud-accounts/export'),
  ...
  exportGenericApiAccounts: () => request('GET', '/config/generic-api-accounts/export'),
